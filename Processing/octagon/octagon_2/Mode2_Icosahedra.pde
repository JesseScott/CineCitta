...
void mode2_Icosahedra() {
  ...
  canvas.pushMatrix();
    canvas.rotateX(frameCount*PI/bg);
    canvas.rotateY(frameCount*PI/bg);
    stroke(br, 0, bb);
    fill(br, bg, 0);
    ico2.create();
  canvas.popMatrix();
  ...
  canvas.pushMatrix();
    canvas.translate(width/3.5, 0);
    canvas.rotateX(frameCount*PI/-bb);
    canvas.rotateY(frameCount*PI/bb);
    stroke(br, bg, bb);
    fill(0, 0, bb);
    ico3.create();
  canvas.popMatrix();
